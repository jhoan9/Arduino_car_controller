...
Serial.print('******************** ' + move);
  if (!move) {
    ...
    std::vector<int> arrayContain;

    for (pos = 0; pos <= gradosPos; pos++) {
      ...
      arrayDist_Pos[0] = pos;
      arrayDist_Pos[1] = DISTANCIA;

      arrayContain.push_back(arrayDist_Pos[0]);
      arrayContain.push_back(arrayDist_Pos[1]);
    ...
    if (grado >= 1 && grado <= 45) {
      girar(300);
    } else if (grado >= 1 && grado <= 45) {
      girar(450);
    } else if (grado >= 46 && grado <= 90) {
      girar(600);
    } else if (grado >= 91 && grado <= 135) {
      girar(750);
    } else if (grado >= 136 && grado <= 180) {
      girar(900);
    } else {
      girar(300);
      retroceder(2000);
